...
export const createInvoicePdf = async (req, res = response) => {
  //
    ...
    for (let i = 0; i < bases.length; i++) {
      ...
      const tableGoodBye = {
        headers: [
          ...
          {
            label: "Gracias por utilizar nuestro servicio, Saludos cordinales.",
            property: "Inri",
            width: 250,
            renderer: null,
          },
...
export const getInvoice = async (req, res = response) => {
...
export const getInvoicePdf = async (req, res = response) => {

...
export const crearDriver = async (req, res = response) => {
  const {
    email,
    password,
    nombre,
  ...
  try {
    const existeDriver = await Driver.findOne({
      email,
...
export const loginDriver = async (req, res = response) => {
...
export const renewTokenDriver = async (req, res = response) => {
  const uid = req.uid;
